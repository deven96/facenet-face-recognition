...
import settings
from . import inception_blocks_v2
...
def triplet_loss(y_true, y_pred, alpha = 0.3):
    """
    Implementation of a custom triplet loss for a siamese network
...
# FRmodel = inception_blocks_v2.faceRecoModel(input_shape=settings.MODEL_INPUT_SHAPE)
